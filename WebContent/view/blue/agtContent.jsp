...
<link href="<%=root%>/view/blue/css/top.css" rel="stylesheet" type="text/css">
<link href="<%=root%>/view/blue/css/all page.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="<%=root%>/view/blue/js/ag_one.js"></script> 
</body>
</html>