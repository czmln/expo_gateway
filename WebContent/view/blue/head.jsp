...
%>
<link href="<%=path%>/view/blue/css/top_.css" rel="stylesheet" type="text/css">
<link href="<%=path%>/view/blue/css/index_.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="<%=path%>/view/blue/js/jquery-1.8.3.min.js"></script> 
<!-- 分页插件 start -->
<link rel="stylesheet" href="<%=path%>/view/blue/css/pagination.css" />
<script type="text/javascript" src="<%=path%>/view/blue/js/jquery.pagination.js"></script> 
...
<div class="head">
  <div class="top"> <img src="<%=path%>/view/blue/images/sy_03.png" class="top-l">
    <div class="top-r">
      <div class="top-qh"> <img src="<%=path%>/view/blue/images/index_03.jpg"><span><a href="<%=path%>/CH">中文</a></span> <img src="<%=path%>/view/blue/images/index_05.jpg"><span><a href="<%=path%>/EN">English</a></span>
        <c:if test="${sessionScope.user_in_session==null}"> 
          <!-- <%=path%>/view/userinfo/jsp/login.jsp --> 
          <span><a href="#">登录</a></span> </c:if>
       ...
       <div class="search_start">
            <div class="search_cont">
               <form  action="<%=path+"/"+shortUrl%>/article/searchArticlePage.do" method="POST">
                <input name="tag" type=hidden value="CH">
                <input type="text" name="keyword" class="in_search" autocomplete="off" value="搜索" style="display:inline-block;line-height:25px;">
                <input type="submit" class="in_submit" value="">
                <i class="icon-search"></i>
              </form>
            </div>
            <a href="#"  class="sea-a" onclick="sub()">高级搜索</a>
          </div>
          <script type="text/javascript">
              function sub(){
...
function getMenuBarByType(){
	...
	$.ajax({
		...
		success:function(data){
			...
			var str='<li class="nav-k"><a href="<%=path+"/"+shortUrl%>" hidefocus="true" class="nav-ys" >首页</a></li>';
