...
$.fn.KinSlideshow = function(settings){
	 ...
	 var imgWidth = settings.imgWidth;
	 var imgHeight = settings.imgHeight;
	 ...
	 function KSS_initialize(){
		 ...
		 $(ksbs+" a img").css({border:0,width:imgWidth,height:imgHeight});
		 KSS_start();
		 KSS_mousehover();
	 };
     ...
     function KSS_start(){
		 ...
		 //设置宽度
		 KSS_Size.push(imgWidth);
		 //设置高度
		 KSS_Size.push(imgHeight);
