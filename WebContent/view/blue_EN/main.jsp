			...
			<div class="s-right">
				<div class="suc-tit">
					...
					<div class="suc-r">
						...
						<span>Position：<a id="goBack" style="display: none;"
							href="javascript:void(0);">Go Back > </a><font></font></span>
					</div>
				</div>
		...
		success:function(data){
			...
			$.each(data,function(i,val){
				...
				if(currentId == 'null'&&i == 0){
					...
					node.addClass("sk").find("img").attr("src","<%=root%>/view/blue_EN/images/icon_06.png");
					...
					node.find("img").attr("src","<%=root%>/view/blue_EN/images/icon_03.jpg");
				}
				node.click(function(){
					$(".s-fl li").removeClass("sk").children().attr("src","<%=root%>/view/blue_EN/images/icon_03.jpg");
					node.addClass("sk").find("img").attr("src","<%=root%>/view/blue_EN/images/icon_06.png");
					$(".suc-tit .zt").html(val.name);
					$(".suc-r").find("span font").html(val.name);
					back_type = val.navType;
	...
	$.ajax({
		...
		success:function(data){
			...
			/* if(data && data.picture){
				...
				$('#advertImg').attr("src",root+"/view/blue_EN/images/default.png");
			} */
		}
	});
}
		...
		<div class="cenav">
			<ul>
				<li class="ce-o ce-li2"><img
					src="<%=root%>/view/blue_EN/images/kk.jpg"></li>
			</ul>
		</div>
	</div>
...
<script type="text/javascript"
	src="<%=root%>/view/blue_EN/js/jquery.nivo.slider.js"></script>
<script type="text/javascript"
	src="<%=root%>/view/blue_EN/js/jquery.floatDiv.js"></script>
<script type="text/javascript" src="<%=root%>/view/blue_EN/js/ag_two.js"></script>
</body>
</html>
