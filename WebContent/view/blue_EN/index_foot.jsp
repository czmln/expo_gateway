...
<div class="bottom" >
      <div class="bot-l">
          <img src="<%=base%>/view/blue_EN/images/weixinerweima.jpg" class="bot-img">
          <h3 class="zt">Scan QR Code<br> Stay current with the WCIIF </h3>
          <img src="<%=base%>/view/blue_EN/images/line_07.jpg" class="bot-line">
           <div class="banner1">
 ...
 <div class="bom">
    <div class="bot">
         <span class="s-l">Copy right：Sichuan Bureru of Expo Affairs Zip Code：610016</span>
         &nbsp;&nbsp;&nbsp;&nbsp; 
         <span> 
         	<script type="text/javascript">
		...
		<span class="s-r">License number：蜀ICP备05030067</span>
    </div>
</div>
