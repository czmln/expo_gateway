	...
	$(function() {
     ...
     function pageselectCallback(page_index, jq){
         ...
         for(var i=page_index*items_per_page;i<max_elem;i++)
         {
        	 ...
        	 if(type == '11'){
        		 switch(members[i][8]){
        		 case 'Exhibition Attraction Contact Information':
        			 newcontent = '<p class="suc-media-focus"><a href="javascript:void(0);" onclick="getView(9,\'2c9087ef4c7e0ae8014c7e132eee0007\',\''+members[i][0]+'\',\''+current_page+'\');">' + members[i][8] + '</a>';
        			 break;
        		 case 'Professional Visitor Registered Contact Information':
        			 newcontent = '<p class="suc-media-focus"><a href="javascript:void(0);" onclick="getView(9,\'53156ee04cd4df32014cd604bc92000c\',\''+members[i][0]+'\',\''+current_page+'\');">' + members[i][8] + '</a>';
        			 break;
        		 case 'Event Contact Information':
        			 newcontent = '<p class="suc-media-focus"><a href="javascript:void(0);" onclick="getView(9,\'53156ee04cd4df32014cd606ab33000d\',\''+members[i][0]+'\',\''+current_page+'\');">' + members[i][8] + '</a>';
        			 break;
        		 }
        	 }else if(type == '12'){
