...
<div class="logo">
    ...
    <div class="c-bg">
         <div class="b-btn">
              <a href="<%=root%>/framework/desktop/index.jsp"><img src="<%=root%>/framework/desktop/images/i-btn_03.png" /></a>
              <a href="<%=root%>/framework/desktop/exposz.jsp"><img src="<%=root%>/framework/desktop/images/i-btn_05.png" /></a>
